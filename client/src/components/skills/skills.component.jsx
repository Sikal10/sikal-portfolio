                    ...
                    <div ref={lineRef} className='header-info-wrap'>
                        <div className="header-content-body skill-one">
                            ...
                            <p className="header body about-one">
                                The main area of my expertise is frontend and backend development and
                        ...
                        <div className="header-content-body gap skill-two">
                            ...
                            <p className="header body about-two gap">
                                As of late, I've also been dabbling in some newer technologies like <strong>React Native</strong>. More than anything, I am always eager to learn and adapt to
